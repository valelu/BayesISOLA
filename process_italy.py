...
class process_italy:
    ...
    :param data: instance with unprocessed data (event and seismograms)
	...
	def __init__(self, data, grid, s_velocity=3000, velocity_ot_the_fastest_wave=8000, velocity_ot_the_slowest_wave=1000,threads=2, invert_displacement=True, use_precalculated_Green=True, correct_data=False, set_parameters=True, fmax=.1, fmin=0.01, min_depth=1000., multichannel=True, skip_short_records=True, suspect_mouse=False,calculate_or_verify_Green=True, trim_filter_data=True, decimate_shift=True,use_stainfo=False):
		self.d = data
		self.grid = grid
